...
public class WordGuardarComo extends JPanel {
    ...
    public WordGuardarComo(Pantalla padre, CardLayout principal, JPanel cards, Editor campo) {
    ...
    public void initComponentes(CardLayout principal, JPanel cards, Editor campo, Pantalla padre) {
        InitBarra(campo, principal, cards, padre);
        Inicializarbotones(campo, principal, cards, padre);
    }

    /** Traduce una WordException a un mensaje legible para el usuario. */
    ...
    private void InitBarra(Editor campo, CardLayout principal, JPanel cards, Pantalla padre) {
        ...
        Guardar.addActionListener(e -> {
            String nombre = campo.label.getText().trim();
            try {
                WordArchivos.guardarComo(campo.editor, WordArchivos.archivoDocumento(nombre), nombre, false);
                principal.show(cards, "editor");
        ...
        Cargar.addActionListener(e -> {
            String nombreArchivo = JOptionPane.showInputDialog(this, "Ingrese el nombre del archivo a cargar:",
                    "Cargar Archivo", JOptionPane.QUESTION_MESSAGE);

            if (nombreArchivo != null && !nombreArchivo.trim().isEmpty()) {
                File archivoACargar = WordArchivos.archivoDocumento(nombreArchivo.trim());
    ...
    private void Inicializarbotones(Editor campo, CardLayout principal, JPanel cards, Pantalla padre) {
        ...
        boton3.addActionListener(e -> {
            ...
            if (nombreTexto.isEmpty()) {
                ...
                try {
                    WordArchivos.guardarComo(campo.editor, WordArchivos.archivoDocumento(nombreTexto), nombreTexto, true);
                    nombre.setText("");
